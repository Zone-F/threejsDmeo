...
const meshColor = "#1B3045";  // 建筑物底部的线条颜色
const headColor = "#ffffff"; // 建筑物顶部的线条颜色
const soundLineColor = '#4f90bb' // 建筑物外围的线条颜色
const risingColor = '#5588AA' // 建筑物扫描线条颜色
const liveColor = '#ffffff' // 场景扫描的颜色
...
export class SurroundLine {
  ...
  createMesh() {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        // 扫描线条的颜色是什么
        u_up_color: {
          value: new THREE.Color(risingColor),
        },
        u_city_color: {
          // 得需要一个模型颜色 最底部显示的颜色
  ...
  createLine() {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        line_color: {
          value: new THREE.Color(soundLineColor)
        },
        ...
        // 扫光的颜色
        live_color: {
          value: new THREE.Color(liveColor)
        }
      },
      vertexShader: `
